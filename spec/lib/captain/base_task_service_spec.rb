...
RSpec.describe Captain::BaseTaskService do
  ...
  describe '#make_api_call' do
    ...
    let(:mock_tokens) { instance_double(RubyLLM::Tokens, input: 10, output: 20) }
    let(:mock_response) { instance_double(RubyLLM::Message, content: 'Response', tokens: mock_tokens) }

...
RSpec.describe Captain::SummaryService do
  ...
  let(:mock_tokens) { instance_double(RubyLLM::Tokens, input: 100, output: 50) }
  let(:mock_response) { instance_double(RubyLLM::Message, content: 'Summary of conversation', tokens: mock_tokens) }

...
describe Whatsapp::Providers::WhatsappCloudService do
  ...
  before do
    allow(GlobalConfigService).to receive(:load).with('WHATSAPP_API_VERSION', 'v24.0').and_return('v24.0')
    stub_request(:get, 'https://graph.facebook.com/v24.0/123456789/message_templates?access_token=test_key')
  end

  describe '#media_url' do
    it 'uses the configured WhatsApp Graph API version' do
      expect(service.media_url('media-id')).to eq('https://graph.facebook.com/v24.0/media-id')
    end
  end
        ...
        stub_request(:get, 'https://graph.facebook.com/v24.0/123456789/message_templates?access_token=test_key')
          .to_return(
            { status: 200, headers: response_headers,
              ...
              ], paging: { next: 'https://graph.facebook.com/v24.0/123456789/message_templates?access_token=test_key' } }.to_json },
            { status: 200, headers: response_headers,
              body: { data: [
            ...
            { status: 200, headers: response_headers,
              ...
              ], paging: { prev: 'https://graph.facebook.com/v24.0/123456789/message_templates?access_token=test_key' } }.to_json }
          )
  ...
  describe '#validate_provider_config' do
    context 'when called' do
      ...
      it 'returns false if invalid' do
        stub_request(:get, 'https://graph.facebook.com/v24.0/123456789/message_templates?access_token=test_key').to_return(status: 401)
